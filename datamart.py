...
# MAGIC %sql
# MAGIC CREATE
# MAGIC OR REPLACE TEMPORARY VIEW ClubMonacoSales AS 
...
# MAGIC %sql
# MAGIC CREATE
# MAGIC OR REPLACE TEMPORARY VIEW CMSalesVip AS
...
# MAGIC     vip_main_no,
# MAGIC     CASE
# MAGIC         WHEN shop_brand = 'CM' THEN first_transaction_date
# MAGIC         ELSE NULL
# MAGIC     END AS first_pur_cm
# MAGIC FROM
# MAGIC     first_pur0
# MAGIC GROUP BY
# MAGIC     vip_main_no,
...
# MAGIC SELECT
# MAGIC     vip_main_no,
# MAGIC     COALESCE(MIN(first_pur_cm), NULL) AS first_pur_cm
# MAGIC FROM
# MAGIC     first_pur1
# MAGIC GROUP BY
# MAGIC     vip_main_no
